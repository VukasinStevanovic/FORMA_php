...
$naslov_stranice = 'Raspored časova';
...
<div class="main-content">
    ...
    <div class="page-naslov">
        <h1>Raspored <span>časova</span></h1>
        <a href="<?= BASE_URL ?>/kontakt.php" class="btn btn-primary btn-sm">Prijavi se za čas</a>
    </div>
    ...
    <?php if (empty($casovi)): ?>
        <div style="text-align:center;padding:60px;color:var(--text2);">
            ...
            <h3>Trenutno nema dostupnih časova.</h3>
